...
Shader "Raygeas/AZURE Water"
{
	Properties
	{
		...
		_RippleRadius("Ripple Radius", Range(0.1, 5.0)) = 1.5
	...
	SubShader
	{
		...
		#define MAX_WATER_INTERACTORS 8
		// Reuses _InteractorPositions / _InteractorCount from GrassInteractionManager

		float3 ComputeRippleNormal(float3 worldPos, float time,
								float radius, float strength,
								float speed, float falloff)
		{
			float3 rippleNormal = float3(0, 0, 0);

			for (int i = 0; i < min(_InteractorCount, 8); i++)
			{
				float3 iPos  = _InteractorPositions[i].xyz;
				float2 delta = worldPos.xz - iPos.xz;
				...
				if (dist < radius && dist > 0.01)
				{
					...
					// Animated ring wave emanating outward
					float wave = sin(dist * 8.0 - time * speed) * influence * strength;

					float2 dir = delta / dist;
					// Encode as a tangent-space normal offset (XZ = normal tilt, Y=0)
								...
								float lifetime)
		{
			...
			for (int i = 0; i < min(_RippleCount, MAX_RIPPLES); i++)
			{
				...
				// Fade out after lifetime seconds
				if (age > lifetime) continue;

				float lifeFade = 1.0 - saturate(age / lifetime);

				// Distance from this pixel to the fixed spawn point (XZ plane)
				float2 delta = worldPos.xz - spawnPos.xz;
				float  dist  = length(delta);

				// The ring radius grows over time
				float ringRadius = age * speed * 2.0;

				// How close is this pixel to the current ring edge?
				float distToRing = abs(dist - ringRadius);
				float ringWidth  = radius * 0.3;             // thin ring band
				float ringMask   = saturate(1.0 - distToRing / ringWidth);

				// Multiple concentric rings (harmonics)
				float wave = sin(dist * 6.0 - age * speed * 8.0) * ringMask * lifeFade * strength;

				// Distance falloff so it doesn't affect pixels far from spawn
				float distFade = saturate(1.0 - dist / (radius * 4.0));
				wave *= distFade;
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				/*#ifdef _RIPPLES_ON
				Normal89 += ComputeRippleNormal(WorldPosition, _TimeParameters.x,
												_RippleRadius, _RippleStrength,
												_RippleSpeed, _RippleFalloff);
				#endif*/

				/*#ifdef _RIPPLES_ON
				// DEBUG: tint water red if any interactor is within 10 units
				for (int di = 0; di < min(_InteractorCount, 8); di++)
				{
					float2 dd = WorldPosition.xz - _InteractorPositions[di].xz;
					if (length(dd) < 10.0)
						BaseColor = float3(1, 0, 0); // red = interactor detected
				}
				Normal89 += ComputeRippleNormal(WorldPosition, _TimeParameters.x,
												_RippleRadius, _RippleStrength,
												_RippleSpeed, _RippleFalloff);
				...
				Normal89 += ComputeRippleNormal(WorldPosition, _TimeParameters.x,
												_RippleRadius,
												_RippleStrength * 5.0,  // boost for testing
												_RippleSpeed,
												_RippleFalloff);
				#endif*/
				...
				Normal89 += ComputeRippleNormal(WorldPosition, _TimeParameters.x,
												...
												_RippleSpeed,
												_RippleFalloff,
												_RippleLifetime // ripple lifetime
												);
				#endif
...
Node;AmplifyShaderEditor.SamplerNode;38;-3437.942,-644.7739;Inherit;True;Property;_TextureSample0;Texture Sample 0;8;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;58a059b07b093a745b47c2191525ddce;True;0;True;bump;Auto;True;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;227;-3812.819,491.8506;Inherit;False;Property;_Color1;Color 1;1;0;Create;True;0;0;0;False;2;Header(Settings);Space(5);False;0,0,0,0;0,0.310371,0.6886792,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;46;-3435.147,-328.2323;Inherit;True;Property;_TextureSample1;Texture Sample 1;9;1;[Normal];Create;True;0;0;0;False;0;False;-1;None;58a059b07b093a745b47c2191525ddce;True;0;True;bump;Auto;True;Instance;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;366;-1434.705,11.53514;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Raygeas/AZURE Water;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;42;Lighting Model;0;0;Workflow;1;0;Surface;1;637778320596734870;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;637778372630113399;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;637778320754783292;  Use Shadow Threshold;0;0;Receive Shadows;1;0;Receive SSAO;1;0;GPU Instancing;0;637778320805607651;LOD CrossFade;0;637778320812924301;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;0;637778320828238216;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;False;True;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;367;-1434.705,11.53514;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;368;-1434.705,11.53514;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;373;-1434.705,71.53514;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;369;-1434.705,11.53514;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;374;-1434.705,71.53514;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;255;False;;255;False;;255;False;;7;False;;1;False;;1;False;;1;False;;7;False;;1;False;;1;False;;1;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=1B8EBBECF1F65340FC9123640B271090935A6EA0